          ...
          <div className="shadow-caca shadow-secondary rounded-xl w-2/6 mt-12 bg-primary">
            <div className=" h-3/6 flex-col justify-center px-6 py-12 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <h2 className="mt-10 text-center font-bold leading-9 tracking-tight">Inscrip<span className="text-accent">tion</span></h2>
                </div>
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <label htmlFor="confirmPassword" className="block text-sm font-medium leading-6 text-accent">Password</label>
                            <div className="mt-2">
